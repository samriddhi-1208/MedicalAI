    ...
    >
      ...
      <div className="p-3 border-t border-slate-200">
        {!collapsed ? (
          <NavLink
            to="/app/sos"
            className="flex items-center gap-2.5 p-2.5 rounded-lg bg-red-50 hover:bg-red-100 border border-red-200 text-red-800 transition-colors"
          >
            <Siren className="w-4 h-4 text-red-600 shrink-0" />
            <div className="text-left">
              <p className="text-xs font-bold text-red-900">{t('emergencySOS')}</p>
              <p className="text-[10px] text-red-700">{t('oneClickDispatch')}</p>
            </div>
          </NavLink>
        ) : (
          <NavLink
            to="/app/sos"
            className="flex items-center justify-center p-2 rounded-lg bg-red-50 text-red-600 border border-red-200"
